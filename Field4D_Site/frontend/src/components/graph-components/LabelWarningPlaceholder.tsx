...
const LabelWarningPlaceholder: React.FC<LabelWarningPlaceholderProps> = ({ fontColor = '#8AC6BB', fontSize = 20 }) => (
  <div className="w-full min-h-[300px] flex items-center justify-center rounded-lg border border-dashed border-gray-300 bg-gray-50">
    <div className="flex items-center gap-3 text-center text-lg md:text-xl text-gray-700 font-semibold px-4">
