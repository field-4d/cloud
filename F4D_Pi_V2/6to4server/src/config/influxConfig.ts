export const influxConfig = {
  Local: {
    token:
      'ukrt-1OBAawssODCbFi1sRdcgU-73E91lbgC5pUhOd8CG_EPJaaXnHfG21OPvN9PIDswgr4s6Nr4TDlrTPTl6A==',
    org: 'fieldarray',
    bucket: 'blackbox',
  ...
  Idan: {
    token:
      '6s62HGpZb0dsXFLycEI7wcOXwo6jFnufwPUG7OYvoakNfPK48hlkGjKS93QBA08HvVZI7cee__lG47fV6myhUw==',
    org: 'home',
    bucket: 'cloud',
  ...
  hujiCloud: {
    token:
      'ru_-kGADQxlgZzixi7xMu0G22F3KPu-9y0p9tMttf0g4UYPRzHMS12p3820nFvW00NLOOaohJ6voYyfaQ_88MQ==',
