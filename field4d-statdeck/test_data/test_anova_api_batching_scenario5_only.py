...
def main():
    ...
    result1 = run_batched_test(
        "Scenario 5 - Sequential by Days (7 days/batch)",
        scenario5_data, "days", 7, test_id=test1_id
    )
    ...
    result2 = run_batched_test(
        "Scenario 5 - Sequential by Size (10K points/batch)",
        scenario5_data, "size", 10000, test_id=test2_id
    )
    ...
    result3 = run_concurrent_batched_test(
        "Scenario 5 - Concurrent by Size (10K points/batch, 1 worker)",
        scenario5_data, "size", 10000, max_workers=1, test_id=test3_id
    )
    ...
    result4 = run_concurrent_batched_test(
        "Scenario 5 - Concurrent by Size (10K points/batch, 2 workers)",
        scenario5_data, "size", 10000, max_workers=2, test_id=test4_id
    )
    ...
    with open(os.path.join(datasets_dir, "scenario5_data.json"), "w") as f:
